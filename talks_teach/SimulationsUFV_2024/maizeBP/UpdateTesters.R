...
bestMaleInbred = MaleHybridYT5@mother[order(MaleHybridYT5@pheno[,1],decreasing=TRUE)[1]]
MaleElite = c(MaleElite[-1],MaleInbredYT5[bestMaleInbred])

bestFemaleInbred = FemaleHybridYT5@mother[order(FemaleHybridYT5@pheno,decreasing=TRUE)[1]]
